...
const Home = () => {
  ...
  return (
   <>
    <div className='h-10 w-full bg-[#caf0f8] flex justify-end items-center' >
      ...
      {access == 'library' && (<Link to = '/books/Create'>
        <button className='bg-[#00b4d8] text-white border rounded mr-2 hover:bg-[#0077b6]'> create</button>
      </Link>)}
    </div>
