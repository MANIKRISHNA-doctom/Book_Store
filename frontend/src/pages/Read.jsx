    ...
    const getbooks = async () => {
      try {
        const res = await axios.get(
          "https://book-store-backend-api-rsv8.onrender.com/books",
    ...
    <>
                ...
                <div className="">
                  <div className="inline-block mr-2">
                    <Link to={`/books/delete/${book._id}`}>
                      <button className="border-2 border-[#adb5bd] rounded-lg bg-[#d90429] hover:bg-[#f08080]">
                        delete
                      </button>
                    </Link>
                  </div>
                  <div className="inline-block">
                    <Link to={`/books/update/${book._id}`}>
                      <button className="border-2 border-[#adb5bd] rounded-lg bg-[#847577] hover:bg-[#e5e6e4]">
                        edit
                      </button>
                    </Link>
                  </div>
      ...
      <div className=" p-2 flex flex-row justify-center border-b-2  ">
        <Link to="/home " state={{ access: access }}>
          <button className="border-2 rounded-sm hover:bg-black hover:text-white">
            HOME
          </button>
        </Link>
      </div>
